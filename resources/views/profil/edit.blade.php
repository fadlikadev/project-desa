                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="fas fa-users"></i> Profile <i class="fas fa-angle-right"></i> Edit
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal text-sm" action="{{url('/profile/' . $data->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="card-body text-sm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir" value="{{old('tempat_lahir')?old('tempat_lahir'):$data->biodata->tempat_lahir}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="date" class="form-control @error ('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan Tempat Lahir" value="{{old('tanggal_lahir')?old('tanggal_lahir'):$data->biodata->tanggal_lahir}}">
                                    ...
                                    <div class="form-group row">
                                        <label for="alamat" class="col-sm-12 col-lg-3 col-form-label">Alamat</label>
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('alamat') is-invalid @enderror" id="alamat" name="alamat" placeholder="Masukkan alamat Pendaftar" value="{{old('alamat')?old('alamat'):$data->biodata->alamat}}">
