                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="fas fa-boxes"></i> Data Fasilitas <i class="fas fa-angle-right"></i> Edit
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Form Edit Data Fasilitas</h3>
                            </div>
                            <!-- /.card-header -->

                            <!-- form start -->
                            <form class="form-horizontal text-sm" action="{{url('/data-fasilitas/' . $data->id)}}" method="post">
                                @csrf
                                @method('put')
                                ...
                                <div class="card-body text-sm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('kode_fasilitas') is-invalid @enderror" id="kode_fasilitas" name="kode_fasilitas" placeholder="Masukkan Kode Fasilitas" value="{{old('kode_fasilitas')?old('kode_fasilitas'):$data->kode_fasilitas}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('nama_fasilitas') is-invalid @enderror" id="nama_fasilitas" name="nama_fasilitas" placeholder="Masukkan Kode Fasilitas" value="{{old('nama_fasilitas')?old('nama_fasilitas'):$data->nama_fasilitas}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <select name="satuan_fasilitas" id="" class="form-control @error ('satuan_fasilitas') is-invalid @enderror">
                                                ...
                                                <option value="Ruangan" <?php if($data->satuan_fasilitas == "Ruangan") echo 'selected' ?>>Ruangan</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="number" class="form-control @error ('jumlah_fasilitas') is-invalid @enderror" id="jumlah_fasilitas" name="jumlah_fasilitas" placeholder="Masukkan Jumlah Fasilitas" value="{{old('jumlah_fasilitas')?old('jumlah_fasilitas'):$data->jumlah_fasilitas}}">
