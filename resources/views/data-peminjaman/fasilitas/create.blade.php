                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Form Tambah Data Peminjaman Fasilitas</h3>
                            </div>
                            <!-- /.card-header -->

                            <!-- form start -->
                            <form class="form-horizontal text-sm" action="{{url('/data-peminjaman/fasilitas')}}" method="post">
                                @csrf
                                ...
                                <div class="card-body text-sm">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            ...
                                            <select name="data_fasilitas_id" id="data_fasilitas_id" class="select2 form-control @error ('data_fasilitas_id') is-invalid @enderror">
                                                ...
                                                @foreach ($dataFasilitas as $item)
                                                    <option value="{{$item->id}}" {{ old('data_fasilitas_id') == $item->id ? "selected" : "" }}>{{$item->nama_fasilitas}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="number" class="form-control @error ('jumlah_pinjaman') is-invalid @enderror" id="jumlah_pinjaman" name="jumlah_pinjaman" placeholder="Jumlah Fasilitas Yang Akan Dipinjam" value="{{old('jumlah_pinjaman')}}">
