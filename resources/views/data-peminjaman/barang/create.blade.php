                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Form Tambah Data Peminjaman Barang</h3>
                            </div>
                            <!-- /.card-header -->

                            <!-- form start -->
                            <form class="form-horizontal text-sm" action="{{url('/data-peminjaman/barang')}}" method="post">
                                @csrf
                                ...
                                <div class="card-body text-sm">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            ...
                                            <select name="data_barang_id" id="data_barang_id" class="select2 form-control @error ('data_barang_id') is-invalid @enderror">
                                                ...
                                                @foreach ($dataBarang as $item)
                                                    <option value="{{$item->id}}" {{ old('data_barang_id') == $item->id ? "selected" : "" }}>{{$item->nama_barang}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <select name="user_id" id="" class="select2 form-control @error ('user_id') is-invalid @enderror">
                                                ...
                                                @else
                                                    ...
                                                    <option value="{{Auth::user()->id}}" {{ old('user_id') == $item->id ? "selected" : "" }}>{{Auth::user()->nama_lengkap}}</option>
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="number" class="form-control @error ('jumlah_pinjaman') is-invalid @enderror" id="jumlah_pinjaman" name="jumlah_pinjaman" placeholder="Masukkan Jumlah Barang Yang Akan Dipinjam" value="{{old('jumlah_pinjaman')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="date" class="form-control @error ('tanggal_pinjam') is-invalid @enderror" id="tanggal_pinjam" name="tanggal_pinjam" placeholder="Masukkan Tanggal Pinjam" value="{{old('tanggal_pinjam')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="date" class="form-control @error ('tanggal_kembali') is-invalid @enderror" id="tanggal_kembali" name="tanggal_kembali" placeholder="Masukkan Tanggal Pengembalian" value="{{old('tanggal_kembali')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" placeholder="Masukkan Keperluan Peminjaman" value="{{old('keterangan')}}">
