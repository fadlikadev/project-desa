                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="fas fa-boxes"></i> Data Barang <i class="fas fa-angle-right"></i> Edit
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal text-sm" action="{{url('/data-barang/' . $data->id)}}" method="post">
                                @csrf
                                @method('put')
                                ...
                                <div class="card-body text-sm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('kode_barang') is-invalid @enderror" id="kode_barang" name="kode_barang" placeholder="Masukkan Kode Barang" value="{{old('kode_barang')?old('kode_barang'):$data->kode_barang}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="text" class="form-control @error ('nama_barang') is-invalid @enderror" id="nama_barang" name="nama_barang" placeholder="Masukkan Kode Barang" value="{{old('nama_barang')?old('nama_barang'):$data->nama_barang}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <select name="satuan_barang" id="" class="form-control @error ('satuan_barang') is-invalid @enderror">
                                                ...
                                                <option value="Buah" <?php if($data->satuan_barang == "Buah") echo 'selected' ?>>Buah</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-lg-8">
                                            <input type="number" class="form-control @error ('jumlah_barang') is-invalid @enderror" id="jumlah_barang" name="jumlah_barang" placeholder="Masukkan Jumlah Barang" value="{{old('jumlah_barang')?old('jumlah_barang'):$data->jumlah_barang}}">
